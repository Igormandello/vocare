...
export const LOAD_MORE_REQUESTED = 'LOAD_MORE_NOTIFICATIONS_REQUESTED';
export const LOAD_MORE_SUCCEEDED = 'LOAD_MORE_NOTIFICATIONS_SUCCEEDED';
export const LOAD_MORE_FAILED = 'LOAD_MORE_NOTIFICATIONS_FAILED';
